...
@interface PageSixteenViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
@implementation PageSixteenViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.title = NSLocalizedString(@"Site 16", @"");
...
- (void)viewDidLoad
{
    ...
    [scrollView setContentSize:CGSizeMake(320, 2760)];
...
- (void) prevController {
    ...
    PageFifteenViewController *pagefifteenVC = [[PageFifteenViewController alloc] initWithNibName: @"PageFifteenViewController" bundle:nil];
    ...
    pagefifteenVC.hidesBottomBarWhenPushed = YES;
    [navigationStack addObject:pagefifteenVC];
    
    [pagefifteenVC release];
...
- (void) nextController {
    ...
    PageSeventeenViewController *pageseventeenVC = [[PageSeventeenViewController alloc] initWithNibName: @"PageSeventeenViewController" bundle:nil];
    // Copy the view controllers stack from the navigation controller
    NSMutableArray *navigationStack = [[NSMutableArray alloc] initWithArray:self.navigationController.viewControllers];
    ...
    // Add the next view controller
    pageseventeenVC.hidesBottomBarWhenPushed = YES;
    [navigationStack addObject:pageseventeenVC];
    
    [pageseventeenVC release];
...
-(void)loadAudioFile {
    ...
    // Load the audio file
    if(player == nil){
        NSString *audioFile = [NSString stringWithFormat:@"nolac16"];
