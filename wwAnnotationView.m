...
- (id)initWithAnnotation:(id <MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    else if([myAnnotation annotationType] == wwPin13)
    {
        ...
        imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PinDRed13.png"]];
        imageView.frame = CGRectMake(kBorder, kBorder, kWidth - 2 * kBorder, kWidth - 2 * kBorder);
        [self addSubview:imageView];
    }
    else if([myAnnotation annotationType] == wwPin14)
    {
        ...
        imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PinDRed14.png"]];
        imageView.frame = CGRectMake(kBorder, kBorder, kWidth - 2 * kBorder, kWidth - 2 * kBorder);
        [self addSubview:imageView];
    }
    else if([myAnnotation annotationType] == wwPin15)
    {
        ...
        imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PinDRed15.png"]];
        imageView.frame = CGRectMake(kBorder, kBorder, kWidth - 2 * kBorder, kWidth - 2 * kBorder);
        [self addSubview:imageView];
    }
    else if([myAnnotation annotationType] == wwPin16)
    {
        ...
        imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PinDRed16.png"]];
        imageView.frame = CGRectMake(kBorder, kBorder, kWidth - 2 * kBorder, kWidth - 2 * kBorder);
        [self addSubview:imageView];
    }
    else if([myAnnotation annotationType] == wwPin17)
    {
        ...
        imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PinDRed17.png"]];
        imageView.frame = CGRectMake(kBorder, kBorder, kWidth - 2 * kBorder, kWidth - 2 * kBorder);
        [self addSubview:imageView];
    }
    else if([myAnnotation annotationType] == wwPin18)
    {
        ...
        imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PinDRed18.png"]];
        imageView.frame = CGRectMake(kBorder, kBorder, kWidth - 2 * kBorder, kWidth - 2 * kBorder);
        [self addSubview:imageView];
    }
