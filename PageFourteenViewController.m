...
@interface PageFourteenViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
@implementation PageFourteenViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.title = NSLocalizedString(@"Site 14", @"");
...
- (void)viewDidLoad
{
    ...
    [scrollView setContentSize:CGSizeMake(320, 2720)];
...
- (void) prevController {
    ...
    PageThirteenViewController *pagethirteenVC = [[PageThirteenViewController alloc] initWithNibName: @"PageThirteenViewController" bundle:nil];
    ...
    pagethirteenVC.hidesBottomBarWhenPushed = YES;
    [navigationStack addObject:pagethirteenVC];
    
    [pagethirteenVC release];
...
-(void)loadAudioFile {
    ...
    // Load the audio file
    if(player == nil){
        NSString *audioFile = [NSString stringWithFormat:@"nolac14"];
