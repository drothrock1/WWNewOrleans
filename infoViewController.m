...
//exclude NSDictionary and rows below for Default screenshot
...
//exclude to here for Default screenshot
	/*
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	*/
	...
	//[nameLabel setTextColor:[UIColor colorWithRed:45/255.0 green:15/255.0 blue:15/255.0 alpha:0.9]];	
