...
@interface PageFifteenViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
@implementation PageFifteenViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.title = NSLocalizedString(@"Site 15", @"");
...
- (void)viewDidLoad
{
    ...
    [scrollView setContentSize:CGSizeMake(320, 2480)];
...
- (void) prevController {
    ...
    PageFourteenViewController *pagefourteenVC = [[PageFourteenViewController alloc] initWithNibName: @"PageFourteenViewController" bundle:nil];
    ...
    pagefourteenVC.hidesBottomBarWhenPushed = YES;
    [navigationStack addObject:pagefourteenVC];
    
    [pagefourteenVC release];
...
- (void) nextController {
    ...
    PageSixteenViewController *pagesixteenVC = [[PageSixteenViewController alloc] initWithNibName: @"PageSixteenViewController" bundle:nil];
    // Copy the view controllers stack from the navigation controller
    NSMutableArray *navigationStack = [[NSMutableArray alloc] initWithArray:self.navigationController.viewControllers];
    ...
    // Add the next view controller
    pagesixteenVC.hidesBottomBarWhenPushed = YES;
    [navigationStack addObject:pagesixteenVC];
    
    [pagesixteenVC release];
...
-(void)loadAudioFile {
    ...
    // Load the audio file
    if(player == nil){
        NSString *audioFile = [NSString stringWithFormat:@"nolac15"];
